...
Voice TTS se publica en npm como [`voice-tts`](https://www.npmjs.com/package/voice-tts). Proporciona una envoltura compacta y tipada sobre `window.speechSynthesis` para aplicaciones web.
